  ...
  window.ScrollEffects = function () {
    ...
    if ($("body").hasClass("hero-below-caption")) {
      ...
      var heroCaptionParallax = gsap.to(
        ...
        { duration: 0.5, yPercent: 10, opacity: 0.3, ease: Linear.easeNone }
      )
      ...
      var heroCaptionParallax = gsap.to(
        "#hero-caption.parallax-scroll-caption",
        { duration: 1, yPercent: 10, opacity: 0.3, ease: Linear.easeNone }
      )
      var heroFooterParallax = gsap.to("#hero-footer", {
        duration: 1,
        yPercent: 15,
    ...
    if ($("body").hasClass("hero-below-caption")) {
      ...
      var nextProjectImageParallax = gsap.to(
        ...
        { duration: 1, top: "0", opacity: 1, ease: Linear.easeNone }
      )
    }
